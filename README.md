...
1. Download the latest [`netflix-auto-skip-v1.0.5.zip`](dist/netflix-auto-skip-v1.0.5.zip) from the [`dist/`](dist/) folder or [GitHub Releases](https://github.com/MPSMeridiaN/Netflix-Auto-Skip/releases).
